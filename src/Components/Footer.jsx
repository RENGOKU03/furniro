...
const Footer = () => {
  return (
    <>
      <div className="grid md:grid-cols-2 border-t-2 justify-center items-center border-[#6e6d6d] mt-10 px-5 bg-pink-50">
        <div className="flex gap-5 flex-col justify-center items-start md:pl-20 pt-5">
